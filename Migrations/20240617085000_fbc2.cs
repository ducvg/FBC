...
{
    /// <inheritdoc />
    public partial class fbc2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConditionNumeric = table.Column<int>(type: "int", nullable: true),
                    NoPage = table.Column<int>(type: "int", nullable: false),
                    Weight = table.Column<decimal>(type: "decimal(10,5)", nullable: true, defaultValue: 0m),
                    Width = table.Column<decimal>(type: "decimal(10,5)", nullable: true, defaultValue: 0m),
                    Length = table.Column<decimal>(type: "decimal(10,5)", nullable: true, defaultValue: 0m),
                    Height = table.Column<decimal>(type: "decimal(10,5)", nullable: true, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Book__3DE0C207C29A701D", x => x.BookId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Category__19093A0B456777E8", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__BookOrde__6D863926FD0C4C09", x => x.BookOrderId);
                    table.ForeignKey(
                        name: "FK__BookOrder__UserI__398D8EEE",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CartOrde__51BCD7B7F1AB39F1", x => x.CartId);
                    table.ForeignKey(
                        name: "FK__CartOrder__UserI__403A8C7D",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    Credit = table.Column<decimal>(type: "decimal(30,5)", nullable: true),
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Exchange__72E6008B0E8B6472", x => x.ExchangeId);
                    table.ForeignKey(
                        name: "FK__ExchangeR__UserI__46E78A0C",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Wallet__84D4F90EC43E767F", x => x.WalletId);
                    table.ForeignKey(
                        name: "FK__Wallet__UserId__2A4B4B5E",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WalletOrderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BankAcountName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__WalletOrder__8VSDVSDVA", x => x.WalletOrderId);
                    table.ForeignKey(
                        name: "FK__Wallet__UserId__84D4F90EC43E767F",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__BookCate__9C7051A779BBAB76", x => new { x.BookId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK__BookCateg__BookI__35BCFE0A",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "BookId");
                    table.ForeignKey(
                        name: "FK__BookCateg__Categ__36B12243",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderDet__0E58350653C60172", x => new { x.BookOrderId, x.BookId });
                    table.ForeignKey(
                        name: "FK__OrderDeta__BookI__3D5E1FD2",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "BookId");
                    table.ForeignKey(
                        name: "FK__OrderDeta__BookO__3C69FB99",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CartDeta__3262DB97E0FE7F12", x => new { x.CartId, x.BookId });
                    table.ForeignKey(
                        name: "FK__CartDetai__BookI__440B1D61",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "BookId");
                    table.ForeignKey(
                        name: "FK__CartDetai__CartI__4316F928",
                        column: x => x.CartId,
